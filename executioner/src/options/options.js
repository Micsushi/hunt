  ...
  ?.addEventListener("submit", async (event) => {
    ...
    const response = await chrome.runtime.sendMessage({
      ...
      payload: {
        ...
        workAuthorized: document.getElementById("profile-work-authorized")
          ?.checked,
        sponsorshipRequired: document.getElementById(
          "profile-sponsorship-required",
        )?.checked,
        willingToRelocate: document.getElementById(
          "profile-willing-to-relocate",
        )?.checked,
        openToAnyLocation: document.getElementById(
          "profile-open-to-any-location",
        )?.checked,
        salaryFlexible: document.getElementById("profile-salary-flexible")
          ?.checked,
