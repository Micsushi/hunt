    ...
    <div className={styles.page}>
      ...
      <div className={styles.panel}>
        <div className={styles.panelHeader}>
          ...
          <span className={`${styles.badge} ${fills.length ? styles.badgeWarn : styles.badgeOk}`}>
            {fills.length}
          </span>
        </div>
        ...
        {!isLoading && !isError && fills.length === 0 ? (
          <p className={styles.meta}>
            No pending browser fills. The extension will pick up tasks automatically when runs are
            triggered.
          </p>
        ) : (
