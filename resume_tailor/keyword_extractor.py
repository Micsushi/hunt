...
STOPWORDS = {
    "the", "and", "with", "for", "that", "this", "you", "your", "are", "our",
    "will", "from", "into", "have", "has", "using", "use", "work", "team",
    "teams", "job", "role", "experience", "required", "preferred",
}

KNOWN_TECH_PHRASES = [
    "python", "java", "kotlin", "typescript", "javascript", "react", "next.js",
    "vue.js", "fastapi", "flask", "docker", "kubernetes", "postgresql", "aws",
    "terraform", "datadog", "rest api", "machine learning", "data analysis",
...
def extract_keywords(*, title: str, description: str | None, classification: dict) -> dict:
    ...
    seniority_signals = [classification.get("job_level")] if classification.get("job_level") not in (None, "unknown") else []
