...
Sessions are stored through hunter.db_compat so SQLite and Postgres modes share
the same code path. Replace on v0.4 with a proper users table.
...
from hunter.db_compat import get_connection  # type: ignore
