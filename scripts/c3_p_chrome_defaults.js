...
function makeWorkdayProfileDefaults(options = {}) {
  ...
  return {
    ...
    addressLine2: "",
    postalCode: "T5J 3S4",
    linkedinUrl: "https://www.linkedin.com/in/wjshi/",
    ...
    currentlyInJobArea: true,
    commuteWillingness: true,
    workLocationWillingness: true,
    alternativePositionsInterest: true,
    aiRecruitingToolsConsent: true,
    talentCommunityOptIn: true,
    futureOpportunitiesOptIn: true,
    futureCommunicationsOptIn: true,
    preferredCommunicationChannel: "Email",
    preferredLanguage: "English",
    travelAvailability: "20% plus",
    salaryFlexible: true,
    familyMemberAtCompany: "No",
    reliabilityStatusClearance:
      "Yes, I meet the requirements to obtain Reliability Status Clearance.",
    activeClearance: true,
    activeSecurityClearance: true,
    usCitizen: false,
    usPersonForExportControl: true,
    usCitizenshipStatus: "Other",
    usCitizenshipStatusExplanation: "Canadian citizen",
    currentUsFederalEmployeeOrMilitary: false,
    formerUsFederalEmployeeOrMilitary: false,
    militarySpouseOrPartner: false,
    nationalGuardOrReserves: false,
    ...
    previousEmployers: "",
    priorTempStaffingAgency: false,
    relatedExperienceYearsRange: "3",
    publicSectorRestriction: false,
    ...
    websites: [
      "https://mshi.ca",
      "https://www.linkedin.com/in/wjshi/",
